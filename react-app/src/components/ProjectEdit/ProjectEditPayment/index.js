          ...
          <section className={paymentStyles.block}>
            ...
            <div className={paymentStyles.lockedContainer}>
              ...
              <div className={paymentStyles.greenText}>
                ...
                <span>
                  {' '}
                  Know the tax implications for running your project as an individual, legal entity, and/or non-profit.
                  {' '}
                </span>
          ...
          <section className={paymentStyles.block}>
            <div className={paymentStyles.infoContainer}>
              ...
              <div className={paymentStyles.mainInputSubHeaderAllow}>
                ...
                {' '}
                Allow up to three business days for confirmation.</div>
            </div>
            <div className={paymentStyles.lockedContainer}>
              <div className={paymentStyles.locked}>
                <div className={paymentStyles.lock}>
        ...
        <div className={paymentStyles.blockWrapper}>
          <section className={paymentStyles.block}>
            <div className={paymentStyles.infoContainer}>
              ...
              <div className={paymentStyles.mainInputSubHeader}>
                Add a checking account that belongs to the individual or entity who will receive funds if the project reaches its goal. The account should support direct deposits and be located in Austria. Projects raising funds in euros can use bank accounts in
                <span className={paymentStyles.applicableLink}>
                  {' '}
                applicable European countries
                </span>
                . We don’t support wire transfers, savings accounts, or virtual bank accounts.</div>
            ...
            <div className={paymentStyles.lockedContainer}>
              ...
              <div className={paymentStyles.greenText}>
                ...
                <span>
                  {" "}
                  Individual funds recipients must personally own this bank account.
          ...
          <section className={paymentStyles.block}>
            ...
            <div className={paymentStyles.lockedContainer}>
              ...
              <div className={paymentStyles.greenText}>
                ...
                <span>
                  {" "}
                  Chargebacks occur when a backer files a dispute.
                  {" "}
                </span>
                <span className={paymentStyles.learnMore}>Learn more...</span>
              </div>
