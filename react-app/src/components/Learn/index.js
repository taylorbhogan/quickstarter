    ...
    <>
      ...
      <div className={styles.featuredContainer}>
        <div className={styles.featuredLarge}>
          <div className={styles.captionsContainer}>
            <span className={styles.captions}>
              ...
              the Anonymous Nobody..., with full creative control
            </span>
          </div>
        </div>
        <div className={styles.featuredSmallTop}>
          <div className={styles.captionsContainer}>
            <span className={styles.captions}>
              With the support of 13, 454 backers, Elena Favilli and Francesca
              Cavallo published Good Night Stories for Rebel Girls - and became
        ...
        <div className={styles.featuredSmallBottom}>
          <div className={styles.captionsContainer}>
            <span className={styles.captions}>
              Since raising over $300k through seven successful projects,
              Craighton Berman now runs his own homewares company with his
              partner, Emily.
            </span>
          </div>
        </div>
      ...
      <div className={styles.quoteContainer}>
        <div className={styles.quotesMargin}>
          <h2 className={styles.quote}>
            <span className={styles.quotationMark}>"</span>We see Quickstarter
            as a home for creative minds and a wonderful platform; where people
            who believe, respect, and see the vision can support an idea and
            make it a reality.
          </h2>
      ...
      <div className={styles.questionsContainer}>
        <h2>
          A Quickstarter project does more than raise money. It builds community
          around your work.
        </h2>
        <h3>What can I use Quickstarter to fund?</h3>
        <div>
          <p>
            Quickstarter is specifically for creative projects in the following
            ...
            about our project guidelines.
          </p>
        </div>
        <h3>Who can I get pledges from?</h3>
        <div>
          <p>
            Millions of people visit Quickstarter every week, but support always
        ...
        <div>
          <p>
            Every Quickstarter project has its share of exhilarating and
