  ...
  return (
    <>
          ...
          <div className={styles.topFlexContainer}>
            <div className={styles.mediaShowcaseContainer}>
              <div className={styles.mediaShowcaseWrapper}>
                <div className={styles.mediaShowcase}>
                  <img
                    ...
                    alt="the media showcase for this project"
                  />
                </div>
              </div>
              <div className={styles.belowShowCaseDiv}>
                ...
                <div>
                  <span className={styles.belowShowCaseIcon}>
                    <i className="far fa-compass"></i>
                  </span>
                  <span className={styles.belowShowCaseText}>
                    {" "}
                    {categories[project.category_id]?.name}
                  </span>
                </div>
                <div>
                  <span className={styles.belowShowCaseIcon}></span>
            ...
            <div className={styles.projectInfoWrapper}>
              <div className={styles.projectInfo}>
                <section>
                  <div className={styles.projectInfoFlexColumn}>
                    <div className={styles.progressBar}>
                      <div
                        ...
                        style={{
                          width: `${
                            project && calculateProgressLimit(project)
                          }`,
                        }}
                      ></div>
                    </div>
                    <div className={styles.projectInfoFlexColumnRow}>
                      <div className={styles.currentFunding}>
                        {currentFundingFormatter.format(
                          project.current_funding
                        )}
                      </div>
                      <div className={styles.subtext}>
                        pledged of{" "}
                        {currentFundingFormatter.format(project.funding_goal)}{" "}
                        goal
                      </div>
                    </div>
                    <div className={styles.projectInfoFlexColumnRow}>
                  ...
                  <div className={styles.allOrNothing}>
                    All or nothing. This project will only be funded if it
                    reaches its goal by {formatDeadline()}.
                  </div>
      ...
      <div className={styles.pinkContainer}>
        <div className={styles.pinkContainerContent}>
          <div className={styles.pinkContainerDiv}>
            <div className={styles.pinkContainerText}>
              Quickstarter connects creators with backers to fund projects.
            </div>
          </div>
          <div className={styles.pinkContainerDiv}>
            <div className={styles.pinkContainerText}>
