export const sections = [
  {
    ...
    blurb: "Discover the artists and organizations using Quickstarter to realize ambitious projects in visual art and performance.",
    subscribeTitle: "Discover new work and big ideas from established and emerging artists.",
  ...
  },
  {
    ...
    categories: ["Comics"],
    blurb: "Explore fantastical worlds and original characters from Quickstarter's community of comics creators and illustrators.",
    subscribeTitle: "Welcome to our library. Peruse the stacks with us.",
    subscribeSubtitle: "Sign up to receive Quickstarter Reads, our Publishing, Comics, and Journalism newsletter."
  },
  {
    id: 3,
    name: "Design & Tech",
    ...
    subscribeSubtitle: "Sign up to receive Invent, Quickstarter's Design and Tech newsletter."
  },
  {
    id: 4,
    name: "Film",
  ...
  },
  {
    ...
    blurb: "See how artisans and entrepreneurs are using Quickstarter to break new ground in food, fashion, and crafts.",
    subscribeTitle: "The zeitgeist, delivered to your inbox.",
    subscribeSubtitle: "Sign up to receive Quickstarter's Happening newsletter, highlighting new projects and buzzworthy stories."
  },
  {
    id: 6,
    name: "Games",
  ...
  },
  {
    ...
    name: "Music",
    categories: ["Music"],
    blurb: "Discover new albums, performances, and independent venues from creators using Quickstarter to shape the future of sound.",
    subscribeTitle: "It's like the radio but nothing sucks and also it’s a newsletter.",
    subscribeSubtitle: "Sign up to receive our Quickstarter Music newsletter, delivered once a month."
  },
  {
    id: 8,
    name: "Publishing",
    categories: ["Journalism", "Publishing"],
    blurb: "Explore how writers and publishers are using Quickstarter to bring new literature, periodicals, podcasts, and more to life.",
    subscribeTitle: "Welcome to our library. Peruse the stacks with us.",
    subscribeSubtitle: "Sign up to receive Quickstarter Reads, our Publishing, Comics, and Journalism newsletter."
  },
];
